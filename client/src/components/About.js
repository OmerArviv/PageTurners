                ...
                <Row>
                    <Col lg={4}>
                        <div className='about-box text-center p-4'>
                            ...
                            <h4 className="fw-light">
                                <button className="about-min-title">Love books</button>
                            </h4>
                    ...
                    <Col lg={4}>
                        <div className='about-box text-center p-4'>
                            ...
                            <h4 className="fw-light">
                                <button className="about-min-title">Diverse styles</button>
                            </h4>
                    ...
                    <Col lg={4}>
                        <div className='about-box text-center p-4'>
                            ...
                            <h4 className="fw-light">
                                <button className="about-min-title">Affordable</button>
                            </h4>
                            <p className="f-15 text-black-50 line-h-26">
